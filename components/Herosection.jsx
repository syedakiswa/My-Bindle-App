...
//               <Image fill className="bg-black left-" src="/volume.webp" alt="Volume button" />
//               <Image fill className="" src="/powerbtn.webp" alt="Power Button" />
//               <Image
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 xl:gap-24 items-center">
          ...
          >
            ...
            >
              ...
              <motion.div
                animate={volumeButtonVariants.animate}
                className="absolute top-24 sm:top-32 lg:top-40 -right-2 sm:right-0 lg:right-1 w-1 h-12 sm:h-16 bg-black  rounded hidden lg:block z-30"
                aria-hidden="true"
              ...
              <motion.div
                animate={powerButtonVariants.animate}
                className="absolute top-48 sm:top-56 lg:top-72 -right-2 sm:right-0 lg:right-1 w-1 h-10 sm:h-14 bg-black rounded hidden lg:block z-30"
                aria-hidden="true"
                title="Power button"
              />
            </motion.div>
